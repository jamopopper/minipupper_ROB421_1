...
def stand(height=127, lean=0, roll=0, leg=4): 
    ...
    if leg == 8:
        ...
        array[1, 2] = ((3.14/2.7) * ((256-height)/256) + 0.2 + ((lean/64) * 0.5) + -((roll/64) * 0.5))
        array[1, 3] = ((3.14/2.7) * ((256-height)/256) + 0.2 + ((lean/64) * 0.5) + ((roll/64) * 0.5))
        array[2, 2] = -((3.14/2.7) * ((256-height)/256) + 0.2 + -((roll/64) * 0.5))
        array[2, 3] = -((3.14/2.7) * ((256-height)/256) + 0.2 + ((roll/64) * 0.5))
    elif leg == 7:
        array[0, 0] = (roll/64) * 0.4
        array[0, 1] = (roll/64) * 0.4
        array[1, 0] = ((3.14/2.7) * ((256-height)/256) + 0.2 + ((lean/64) * 0.5) + -((roll/64) * 0.5))
        array[1, 1] = ((3.14/2.7) * ((256-height)/256) + 0.2 + ((lean/64) * 0.5) + ((roll/64) * 0.5))
        array[2, 0] = -((3.14/2.7) * ((256-height)/256) + 0.2 + -((roll/64) * 0.5))
        array[2, 1] = -((3.14/2.7) * ((256-height)/256) + 0.2 + ((roll/64) * 0.5))
    elif leg == 6:
        array[0, 1] = (roll/64) * 0.4
        array[0, 2] = (roll/64) * 0.4
        array[1, 1] = ((3.14/2.7) * ((256-height)/256) + 0.2 + ((lean/64) * 0.5) + ((roll/64) * 0.5))
        ...
        if leg == 0 or leg == 2:
            ...
            array[1, leg] = ((3.14/2.7) * ((256-height)/256) + 0.2 + ((lean/64) * 0.5) + -((roll/64) * 0.5))
            array[2, leg] = -((3.14/2.7) * ((256-height)/256) + 0.2 + -((roll/64) * 0.5))
        else:
            array[0, leg] = (roll/64) * 0.4
            array[1, leg] = ((3.14/2.7) * ((256-height)/256) + 0.2 + ((lean/64) * 0.5) + ((roll/64) * 0.5))
            array[2, leg] = -((3.14/2.7) * ((256-height)/256) + 0.2 + ((roll/64) * 0.5))
