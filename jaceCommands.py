...
def turn_around(height, offset, hw_face):
    ...
    keyframe(0.2, (store1a + store1b + store2a + store2b), (leg_up_1 + store1a + store2b), hw_face)
    keyframe(0.2, (leg_up_1 + store1a + store2b), (leg_set_1 + store1a + store2b), hw_face)
    keyframe(0.2, (leg_set_1 + store1a + store2b), (leg_set_1 + leg_up_2), hw_face)
    keyframe(0.2, (leg_set_1 + leg_up_2), (leg_set_1 + leg_set_2), hw_face)
