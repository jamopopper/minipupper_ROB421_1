...
def sidestep0_2(array, phase):
    store = stand(array, 2*phase, 0, phase, 0)
    return store
...
def sidestep1_2(array, phase):
    store = stand(array, 2*phase, 0, phase, 1)
    return store
...
def sidestep2_2(array, phase):
    store = stand(array, 2*phase, 0, phase, 2)
    return store
...
def sidestep3_2(array, phase):
    store = stand(array, 2*phase, 0, phase, 3)
    return store
...
def sidestep5_2(array, phase):
    store = stand(array, 2*phase, 0, phase, 5)
    return store
...
def sidestep6_2(array, phase):
    store = stand(array, 2*phase, 0, phase, 6)
    return store
