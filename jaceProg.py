...
def stand(array, height=127, lean=0, leg=4): 
    ...
    if leg == 4:
        ...
        array[1, 0] = ((3.14/5) * ((128-height)/256) + 0.1)
        array[1, 1] = ((3.14/5) * ((128-height)/256) + 0.1)
        array[1, 2] = ((3.14/5) * ((128-height)/256) + 0.1)
        array[1, 3] = ((3.14/5) * ((128-height)/256) + 0.1)
        array[2, 0] = -((3.14/5) * ((128-height)/256) + 0.1)
        array[2, 1] = -((3.14/5) * ((128-height)/256) + 0.1)
        array[2, 2] = -((3.14/5) * ((128-height)/256) + 0.1)
        array[2, 3] = -((3.14/5) * ((128-height)/256) + 0.1)
    else:
        array[0, leg] = (lean/64) * 0.5
        array[1, leg] = ((3.14/5) * ((128-height)/256) + 0.1)
        array[2, leg] = -((3.14/5) * ((128-height)/256) + 0.1)
