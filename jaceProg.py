...
def main(use_imu=False):
    ...
    for i in range(256):
        ...
        state.joint_angles[1, 0] = (3.14/(((i/256)*10)+2.25))
        state.joint_angles[1, 1] = (3.14/(((i/256)*10)+2.25))
        state.joint_angles[1, 2] = (3.14/(((i/256)*10)+2.25))
        state.joint_angles[1, 3] = (3.14/(((i/256)*10)+2.25))
        state.joint_angles[2, 0] = -(3.14/(((i/256)*10)+2.25))
        state.joint_angles[2, 1] = -(3.14/(((i/256)*10)+2.25))
        state.joint_angles[2, 2] = -(3.14/(((i/256)*10)+2.25))
        state.joint_angles[2, 3] = -(3.14/(((i/256)*10)+2.25))
