...
def main(use_imu=False):
    ...
    for iteration in range(128):
        state.joint_angles[1, 0] = (3.14/2)*(iteration/128) - (3.14/4)
        state.joint_angles[1, 1] = (3.14/2)*(iteration/128) - (3.14/4)
        state.joint_angles[1, 2] = (3.14/2)*(iteration/128) - (3.14/4)
        state.joint_angles[1, 3] = (3.14/2)*(iteration/128) - (3.14/4)
        hardware_interface.set_actuator_postions(state.joint_angles)
        time.sleep(10/128)
        state.joint_angles[2, 0] = (3.14/2)*(iteration/128) - (3.14/4)
        state.joint_angles[2, 1] = (3.14/2)*(iteration/128) - (3.14/4)
        state.joint_angles[2, 2] = (3.14/2)*(iteration/128) - (3.14/4)
        state.joint_angles[2, 3] = (3.14/2)*(iteration/128) - (3.14/4)
        hardware_interface.set_actuator_postions(state.joint_angles)
        time.sleep(10/128)
